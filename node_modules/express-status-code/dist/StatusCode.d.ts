export declare const StatusInformationResponse: {
...
export declare const StatusSucessfulResponse: {
    /**
...
export declare const StatusRedirectionMessage: {
...
export declare const StatusClientErrorResponse: {
...
export declare const StatusServerErrorResponse: {
...
export declare function getStatusCode(code: keyof (typeof StatusCode)): number;
/**
* Status Code
*
